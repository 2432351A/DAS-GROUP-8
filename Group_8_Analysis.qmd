...
Note that the following work is done with the removal of the variable votes in order to make the model have a better fit. The final optimal model will be obtained at a later stage.
```{r}
#| echo: false
#confint(glm1) %>%
# kable()
